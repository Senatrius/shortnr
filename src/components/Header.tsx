...
export const Header = () => {
  ...
  return <header className="mx-auto w-[87%] relative flex items-center justify-between pt-10">
    ...
    <nav className={`absolute rounded-lg w-full pt-7 px-6 pb-10 bg-primary-200 top-24 ${isMenuOpen ? "block" : "hidden"} sm:w-[75%] sm:right-0 md:relative md:w-full md:flex md:flex-row md:ml-10 items-center md:top-0 md:p-0 md:bg-0`}>
